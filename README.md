...
Bu proje; hangi kullanıcının, hangi fabrikada, hangi raf üzerinden hangi üründen kaç adet alıp bıraktığını izlemek ve stok dengesini korumak için tasarlanmıştır.
...
Hareket Geçmişi: Ürünlerin giriş/çıkış tarihlerinin ve işlem yapan kullanıcıların loglanması.
...
Projede Code First yaklaşımı benimsenmiştir. Temel varlıklar ve ilişkiler şu yapı üzerine kurulmuştur:
